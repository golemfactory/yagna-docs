...
For example, with the following setup, each event emitted by `engine` will be logged by `log_event_json`, and additionally, certain events will cause summary messages to be logged.
...
Stops exposing GFTP urls created by [publish\(files=\[..\]\)](https://github.com/golemfactory/yagna-docs/tree/1cc607b07ae271f5fc70a4936803a697f28b3a7f/yapapi/%60publish%60/README.md).
