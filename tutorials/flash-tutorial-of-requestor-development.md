...
First, download the package appropriate for your platform from: [https://github.com/golemfactory/yagna/releases/tag/v0.3.3-alpha](https://github.com/golemfactory/yagna/releases/tag/v0.3.3-alpha.5)
