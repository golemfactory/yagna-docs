...
```text
curl -sSf https://join.golem.network/as-requestor | YA_INSTALLER_CORE=pre-rel-v0.6.0-rc3 bash -
```
...
First, download the requestor package - prefixed `golem-requestor` - appropriate for your platform from: [https://github.com/golemfactory/yagna/releases/tag/pre-rel-v0.6.0-rc3](https://github.com/golemfactory/yagna/releases/tag/pre-rel-v0.6.0-rc3)
