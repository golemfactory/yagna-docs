...
```text
curl -sSf https://join.golem.network/as-requestor | YA_INSTALLER_CORE=pre-rel-v0.6.0-rc6 bash -
```
...
First, download the requestor package - prefixed `golem-requestor` - appropriate for your platform from: [https://github.com/golemfactory/yagna/releases/tag/pre-rel-v0.6.0-rc6](https://github.com/golemfactory/yagna/releases/tag/pre-rel-v0.6.0-rc6)
...
It should output: `yagna 0.6.0-rc6 (8318260e 2021-02-04 build #109)`
...
It should output: `gftp 0.6.0-rc6 (8318260e 2021-02-04 build #109)`
...
```text
pip3 install -U pip
pip install --extra-index-url https://test.pypi.org/simple/ yapapi==0.5.0a3
```
