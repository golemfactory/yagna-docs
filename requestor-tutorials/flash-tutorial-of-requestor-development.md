...
First, download the requestor package - prefixed `golem-requestor` - appropriate for your platform from: [https://github.com/golemfactory/yagna/releases/tag/v0.6.2](https://github.com/golemfactory/yagna/releases/tag/v0.6.2)
...
It should output: `yagna 0.6.2 (6947e449 2021-03-22 build #127)`
...
It should output: `gftp 0.6.2 (6947e449 2021-03-22 build #127)`
