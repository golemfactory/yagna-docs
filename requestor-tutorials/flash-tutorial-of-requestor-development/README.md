...
First, download the requestor package - prefixed `golem-requestor` - appropriate for your platform from: [https://github.com/golemfactory/yagna/releases/tag/v0.9.2](https://github.com/golemfactory/yagna/releases/tag/v0.9.2).
...
It should output: `yagna 0.9.2 (d4a24786 2022-01-10 build #191)`
...
It should output: `gftp 0.9.2 (d4a24786 2022-01-10 build #191)`
