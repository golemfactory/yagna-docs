...
First, download the requestor package - prefixed `golem-requestor` - appropriate for your platform from: [https://github.com/golemfactory/yagna/releases/tag/v0.9.1](https://github.com/golemfactory/yagna/releases/tag/v0.9.1).
...
It should output: `yagna 0.9.1 (18876615 2021-12-20 build #189)`
...
It should output: `gftp 0.9.1 (18876615 2021-12-20 build #189)`
